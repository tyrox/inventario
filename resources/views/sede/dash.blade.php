		                    ...
		                    <tbody>
		                        @foreach($sedes as $sede)
		                            <tr>
		                                ...
		                                <td class="text-right">
		                                    <a class="btn btn-xs btn-primary" href="{{ route('sedes.show', $sede->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
		                                    <a class="btn btn-xs btn-warning" href="{{ route('sedes.edit', $sede->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
